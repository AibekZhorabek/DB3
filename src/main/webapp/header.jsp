        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="container border-right mr-3">
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link" href=""><fmt:message key = "card.pharmacy"/></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href=""><fmt:message key = "card.medicines"/></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="">Мед.центры</a>
                    </li>
                    <li class="nav-item">
            ...
            <form class="form-inline my-2 my-lg-0 mr-3" title="Select language" action="changeLanguage" method="post">
                <input type="hidden" name="returnTo" value="${pageUrl}">
                <select class="form-control" name="language" onchange="this.form.submit()" id="select1">
                    <option value="ru" <c:if test="${\"ru\" == sessionScope.currentLanguage }"><c:out value = "selected"/></c:if>>Shymkent</option>
                    <option value="en" <c:if test="${\"en\" == sessionScope.currentLanguage }"><c:out value = "selected"/></c:if>>EN</option>
                </select>
            </form>
