...
<div class="container-fluid py-5 bg-light" style="background-color: #F2F4F8;">
    <div class="container">
            ...
            <div class="col-6 offset-3">
                <form>
                    <div class="input-group shadow-sm">
                        <input type="text" class="form-control" id="searchPharmacy" onkeyup="searchPharmacyOnKeyUp()" placeholder="Поиск врачей">
        ...
        <div class="row">
            <div class="col-6 offset-3">
                <p class="countOfPharmacy">Найдено ${fn:length(requestScope.doctorsFromCity)} аптек</p>
            </div>
        </div>
        <div class="row">
            <div class="col-6 offset-3">
                <c:forEach var = "doctor" items="${requestScope.doctorsFromCity}">
                    <div class="card mb-3 shadow-sm cards">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h5 class="card-title">${doctor.surname} ${doctor.name}</h5>
                                    <h6 class="card-subtitle mb-2 text-muted"><c:out value = "${pharmacy.address}"/></h6>
                                    <span style="color: royalblue;"><i class="fas fa-phone"></i>  <c:out value = "${doctor.phone}"/></span>
                                    <p class="card-text">${doctor.briefInfo}</p>
